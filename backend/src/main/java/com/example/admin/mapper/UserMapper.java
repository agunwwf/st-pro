...
public interface UserMapper {
    ...
    @Update("UPDATE sys_user SET nickname=#{nickname}, avatar=#{avatar}, signature=#{signature}, progress=#{progress}, check_in_count=#{checkInCount}, is_model=#{isModel} WHERE id=#{id}")
