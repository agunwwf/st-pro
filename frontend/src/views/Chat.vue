  ...
  <div class="chat-layout glass-card">
      ...
      <div class="friend-list">
        ...
        >
          <div class="avatar-wrapper">
            <el-avatar :size="54" :src="f.friendAvatar" shape="square" class="avatar-img" />
    ...
    <section class="chat-wrapper">
      ...
      <div class="messages-area" ref="msgArea">
        ...
        >
          <el-avatar v-if="msg.fromUser !== currentUser.username" :size="44" :src="activeFriend.friendAvatar" class="avatar" shape="square" />
          <div class="bubble-container">
            ...
            <div class="bubble">
              ...
              <template v-else-if="msg.msgType === 'file'">
                <a class="file-link" :href="msg.content" target="_blank">
                  <el-icon class="file-icon"><Folder /></el-icon>
                  <span class="file-name">文件附件</span>
                </a>
              </template>
              <template v-else>
                {{ msg.content }}
    ...
    <el-dialog v-model="showRequests" title="好友申请" width="450px" align-center class="custom-dialog">
      ...
      <div v-else class="request-list">
        <div v-for="req in pendingRequests" :key="req.id" class="request-item">
          <el-avatar :size="48" :src="req.friendAvatar" />
          <div class="req-info">
...
const searchAndAdd = async () => {
  ...
  try {
    ...
    if (searchRes.data.code !== 200) return ElMessage.error('未找到该用户')

    const targetUser = searchRes.data.data
...
const handleImageSelected = (e) => {
  ...
  // 真实场景应上传到服务器获取 URL，这里简化为 Base64
...
const handleFileSelected = (e) => {
  ...
  // 真实场景应上传到服务器，这里简化演示
  // sendMessage('file', file.name) // 仅发送文件名演示
  ElMessage.info('文件发送功能需对接文件服务器，此处仅做演示')
  e.target.value = ''
}
